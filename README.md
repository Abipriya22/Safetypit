# ⛏️ SafetyPit — Mining Safety Platform
...
```bash
clone https://github.com/Abipriya22/Safetypit.git
```
...
- Workers submit hazard/incident reports from the app
- Reports stored in `incident_report` table
- Supervisors can view and update report status
- Notification auto-generated for supervisors on new reports
